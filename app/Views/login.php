...
>
  ...
  <body>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="login_form" name="login_form" class="mb-3">
                ...
                <div class="mb-3">
                  <button class="btn btn-primary d-grid w-100" id="admin_login_btn" type="submit">Sign in</button>
                </div>
              </form>
    ...
    <script src="<?php echo base_url(); ?>/public/assets/vendor/libs/jquery-validation/dist/jquery.validate.js"></script>

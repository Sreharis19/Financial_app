                    ...
                    <tbody>
                        <?php foreach ($clients as $key => $client) : ?>
                            <tr>
                                ...
                                <td>
                                    <button title="Edit" type="button" onclick="location.href = '<?php echo base_url(); ?>/public/step1?id=<?= $client->id ?>';" class="btn rounded-pill btn-secondary">
                                        <span class="tf-icons bx bxs-chat"></span>&nbsp; Edit
                                    </button>
                                </td>
								  <td>
                                    <div title="Add" class="btn-group" role="group" aria-label="First group">
                                        <button type="button" onclick="location.href = '<?php echo base_url(); ?>/public/Ma_Client_View?id=<?= $client->id ?>';" class="btn btn-outline-secondary">
                                            <i title="Add" class='tf-icons bx bx-street-view'></i>
                                        </button>
                                    </div>
                                </td>

                                ...
                                <td><?php if ($client->user_status == 1) : ?> <?= "Active" ?> <?php else : ?> <?= "Blocked" ?> <?php endif; ?></td>
                                    ...
                                    <td>
                                     ...
                                     <div  class="btn-group" role="group" aria-label="First group">
                                        <button type="button" onclick="location.href = '<?php echo base_url(); ?>/public/Ma_Rm_View?id=<?= $client->id ?>';" class="btn btn-outline-secondary">
                                            <i title="view" class='tf-icons bx bx-street-view'></i>
                                        </button>
                                   
                                        <button type="button" onclick="location.href = '<?php echo base_url(); ?>/public/Ma_Rm_Edit?id=<?= $client->id ?>';" class="btn btn-outline-secondary">

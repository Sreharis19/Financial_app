      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="<?php echo base_url(); ?>/public/Admin_dashboard" class="menu-link">
            ...
            <li class="menu-header small text-uppercase">
             ...
             <li class="menu-item">
              <a href="<?php echo base_url(); ?>/public/Ma_Client_List" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo base_url(); ?>/public/Ma_Post_List" class="menu-link">
                <i class="menu-icon tf-icons bx bx-collection"></i>
            ...
            <li class="menu-item">
              <a
                href="<?php echo base_url(); ?>/public/Ma_Support_List"
                class="menu-link"
              >

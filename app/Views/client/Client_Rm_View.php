 ...
 <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div style="float: right;">
                            <button type="button" onclick="location.href = '<?php echo base_url(); ?>/public/Client_Rm_List';" class="btn btn-primary">
                                <span class="tf-icons bx bx-arrow-back">
                                </span>&nbsp; Back To Relationship Manager List
                            </button>
                        </div>
                        <br>
                        <br>
                        ...
                        <div class="card" style="padding-top: 10px; padding-left: 05px; padding-right: 05px;">
                            <div class="col-xl-10" style="padding-top: 30px; padding-left: 80px; padding-right: 80px;">
                                <!-- HTML5 Inputs -->
                                <div class="card mb-4">
                                    <h5 class="card-header">View Relationship Manager Details</h5>
                                    <div class="card-body">
                                        <div class="mb-3 row">
                                            <label for="first_name" class="col-md-2 col-form-label">First Name :</label>
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" id="first_name" value="<?= $viewRm->first_name ?>"
                                                    disabled />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="text" id="last_name" value="<?= $viewRm->last_name ?>"
                                                    disabled />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="email" id="email"
                                                    value="<?= $viewRm->user_email ?>" disabled />
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <?php foreach ($viewRm->product as $value) : ?>

        ...
        <div class="card" style="padding-top: 10px; padding-left: 05px; padding-right: 05px;">
            <div class="col-xl-10" style="padding-top: 30px; padding-left: 80px; padding-right: 80px;">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="mb-3 row">
                            <label for="first_name" class="col-md-2 col-form-label">Post Title :</label>
                            <div class="col-md-07">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-md-6 col-lg-4 mb-3">
                                <div class="card h-100">
                                    ...
                                    <img src="<?= base_url('public/assets/uploads/post/' . $post->post_image) ?>" alt="" />
                        ...
                        <br>
                        <div style="float: right;">
                            <button type="button" title="Chat" onclick="location.href = '<?php echo base_url(); ?>/public/client_selectRm?id=<?= $post->_id ?>';" class="btn rounded-pill btn-secondary">
